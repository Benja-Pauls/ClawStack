...
- **Backend**: FastAPI, Python 3.12+, async SQLAlchemy 2.0 (asyncpg), Alembic, pydantic-settings, structlog, SlowAPI
- **Frontend**: React 18, Vite, TypeScript (strict), Tailwind CSS v4, React Router, React Query
